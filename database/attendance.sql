...
--
-- Host: localhost:3306
-- Generation Time: Apr 03, 2024 at 06:34 AM
...
CREATE TABLE `attendance` (
  ...
  `status` int NOT NULL COMMENT '0 for Absent and 1 for Present',
...
INSERT INTO `students` (`id`, `full_name`, `mobile`, `age`, `class_id`) VALUES
(1, 'Abdiaziz', '9', 23, 1),
(2, 'Said', '90', 25, 1);
